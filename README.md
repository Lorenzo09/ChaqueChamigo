...
Este proyecto busca aportar al ciudadano correntino, la información suficiente para que tome la mejor decisión posible al manejar. Para su desarrollo, se utilizan los datos disponibles en el Portal de Datos Abiertos (agregar link). Los datos se transforman y se analizan para para luego ser almacenada y deployada.

## Contexto

La ciudad de corrientes tiene materia pendiente en cuanto a los siniestros viales. Si bien, en los años anteriores se ha hecho un esfuerzo para disminuir el número de siniestros, la situación sigue siendo preocupante.

Para este proyecto se utilizarán los datos de siniestros viales de la ciudad de Corrientes, Argentina.

## Datos

Para este proyecto se leerán ocho archivos CSV:
